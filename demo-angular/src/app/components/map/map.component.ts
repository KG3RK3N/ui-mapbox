...
import { Component, HostListener, Input, NgZone, OnDestroy, OnInit, ViewChild, ViewContainerRef } from '@angular/core';

import * as dialogs from '@nativescript/core/ui/dialogs';

// Mapbox GL Native API

import { Mapbox, MapboxViewApi } from '@nativescript-community/ui-mapbox';
